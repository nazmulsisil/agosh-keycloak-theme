					...
					<div class='layout__right-content'>
						...
						<div class='placeholder' >
							<div class='placeholder__row'>
									...
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-2 placeholder__block--shape-rounded' >
										<img  src="${url.resourcesPath}/img/02.png" alt='placeholder' />
									</div>
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-3 placeholder__block--shape-bottom placeholder__block--vertical'  >
										<img  src="${url.resourcesPath}/img/03.png" alt='placeholder' />
									</div>									
							</div>
							<div class='placeholder__row'>								
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-4 placeholder__block--shape-top placeholder__block--vertical' >
									...
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-6 placeholder__block--shape-bottomRight' >
							...
							<div class='placeholder__row'>								
									...
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-8 placeholder__block--shape-right placeholder__block--vertical' >
										<img  src="${url.resourcesPath}/img/08.png" alt='placeholder' />
									</div>
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-9 placeholder__block--shape-bipolar' >
										<img  src="${url.resourcesPath}/img/09.png" alt='placeholder' />
									</div>									
							</div>
							<div class='placeholder__row'>								
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-10 placeholder__block--shape-topRight' >
										<img  src="${url.resourcesPath}/img/10.png" alt='placeholder' />
									</div>
									<div class='placeholder__block placeholder__block--delay1 placeholder__block--color-11 placeholder__block--shape-rounded placeholder__block--vertical' >
